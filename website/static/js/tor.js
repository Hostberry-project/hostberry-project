...
(function () {
  ...
  function hideTorCircuitSection(circuitInfo) {
    ...
    circuitInfo.classList.add('d-none');
  }
  ...
  function showTorCircuitSection(circuitInfo) {
    ...
    window.HostBerry&&window.HostBerry.setVisible(circuitInfo, true);
    const al = circuitInfo.querySelector('.alert');
    if (al) {
      al.classList.remove('d-none');
      window.HostBerry&&window.HostBerry.setVisible(al, true);
  ...
  async function loadTorStatus() {
    try {
      ...
      if (status?.installed) {
        if (installedIcon) window.HostBerry&&window.HostBerry.setVisible(installedIcon, true, 'inline-block');
        if (notInstalledIcon) notInstalledIcon.classList.add('d-none');
        if (installationText) installationText.textContent = t('tor.installed', 'Installed');
        if (installBtn) installBtn.classList.add('d-none');
        if (configureBtn) window.HostBerry&&window.HostBerry.setVisible(configureBtn, true);
        ...
        if (status?.active) {
          ...
          if (disableBtn) window.HostBerry&&window.HostBerry.setVisible(disableBtn, true);
          if (circuitInfo) window.HostBerry&&window.HostBerry.setVisible(circuitInfo, true);
          ...
          if (status?.iptables_active) {
            ...
            if (iptablesEnableBtn) iptablesEnableBtn.classList.add('d-none');
            if (iptablesDisableBtn) window.HostBerry&&window.HostBerry.setVisible(iptablesDisableBtn, true, 'inline-block');
          } else {
            ...
            if (iptablesEnableBtn) window.HostBerry&&window.HostBerry.setVisible(iptablesEnableBtn, true, 'inline-block');
            if (iptablesDisableBtn) iptablesDisableBtn.classList.add('d-none');
          }
        } else {
          ...
          if (enableBtn) window.HostBerry&&window.HostBerry.setVisible(enableBtn, true);
          if (disableBtn) disableBtn.classList.add('d-none');
          hideTorCircuitSection(circuitInfo);
          if (torIpText) torIpText.textContent = '--';
        }
      } else {
        if (installedIcon) installedIcon.classList.add('d-none');
        if (notInstalledIcon) window.HostBerry&&window.HostBerry.setVisible(notInstalledIcon, true, 'inline-block');
        ...
        if (installBtn) window.HostBerry&&window.HostBerry.setVisible(installBtn, true);
        if (configureBtn) configureBtn.classList.add('d-none');
        if (enableBtn) enableBtn.classList.add('d-none');
        if (disableBtn) disableBtn.classList.add('d-none');
        hideTorCircuitSection(circuitInfo);
        if (torIpText) torIpText.textContent = '--';
  ...
  async function loadTorCircuit() {
    try {
      ...
      if (
        ...
        window.HostBerry&&window.HostBerry.setVisible(circuitAlert, true);
  ...
  function bindTorPageButtons() {
    document.getElementById('tor-install-btn')?.addEventListener('click', installTor);
    document.getElementById('tor-configure-btn')?.addEventListener('click', showTorConfig);
    document.getElementById('tor-enable-btn')?.addEventListener('click', enableTor);
    document.getElementById('tor-disable-btn')?.addEventListener('click', disableTor);
    document.getElementById('tor-iptables-enable-btn')?.addEventListener('click', enableTorIptables);
    document.getElementById('tor-iptables-disable-btn')?.addEventListener('click', disableTorIptables);
    document.getElementById('tor-refresh-circuit-btn')?.addEventListener('click', loadTorCircuit);
  }
