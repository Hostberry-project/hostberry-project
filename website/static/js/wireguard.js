...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    document.getElementById('wireguard-toggle-btn')?.addEventListener('click', toggleWireGuard);
    document.getElementById('wireguard-restart-btn')?.addEventListener('click', restartWireGuard);
    loadConfig();
    loadInterfaces();
    loadPeers();
