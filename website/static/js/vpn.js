...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    document.getElementById('vpn-toggle-btn')?.addEventListener('click', toggleVPN);
    document.getElementById('vpn-connect-btn')?.addEventListener('click', connectVPN);
    document.getElementById('openvpn_save_btn')?.addEventListener('click', saveOpenVPNConfig);
    document.getElementById('openvpn_connect_btn')?.addEventListener('click', connectOpenVPN);
    document.getElementById('vpn-generate-certs-btn')?.addEventListener('click', generateCertificates);
    document.getElementById('vpn-view-logs-btn')?.addEventListener('click', viewSecurityLogs);
    loadConnections();
    loadServers();
    loadClients();
    loadOpenVPNConfig();
